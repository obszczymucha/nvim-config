...
function Provider.new( args )
  log:trace( "Custom Telescope actions provider triggered" )
...
function Provider:picker( items, opts )
  ...
  return pickers
      .new( opts, {
        ...
        layout_config = {
          width = 50,          -- Custom width - 90% of screen
          height = 14,         -- Custom height - 80% of screen
          preview_width = 0.6, -- Preview takes 60% of the picker width
        },
